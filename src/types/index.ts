...
export const CreateRaffleSchema = z.object({
  ...
  prizeValueInCents: z.number().int().positive('Valor do prêmio deve ser positivo'),
  bannerDesktopUrl: z.string().url().optional().or(z.literal('')),
  bannerMobileUrl: z.string().url().optional().or(z.literal('')),
