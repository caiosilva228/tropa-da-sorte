...
export default async function AdminLayout({
  ...
  // Em produção ou em rotas autenticadas, redirecionar se não autenticado
  // (A página /admin/login trata seu próprio form de login)
    ...
    <div className="min-h-screen bg-[#101214] text-white flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-64 bg-[#181B1F] border-b md:border-b-0 md:border-r border-[#262A30] flex flex-col shrink-0">
        ...
        <nav className="p-3 flex md:flex-col gap-1 overflow-x-auto md:overflow-x-visible flex-1">
          <Link
            href="/admin"
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-bold text-gray-300 hover:text-white hover:bg-[#101214] transition-colors whitespace-nowrap"
          >
